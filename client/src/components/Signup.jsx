...
const Login = () => {
  return (
    <div className="min-h-screen bg-[#f0f2f5] flex items-center justify-center">
      <div className="bg-white w-[410px] rounded-md px-6 py-8 mt-2 shadow-sm">
        {/* Logo */}
        ...
        <form className="flex flex-col gap-4">
          <input
            ...
            className="w-full h-12 border border-gray-300 rounded-md px-3 outline-none"
          />
          ...
          {/* Cloudflare */}
          <div className="border border-gray-300 rounded-md px-4 py-5 flex justify-between items-center">
            <span>✅ Success!</span>
            <span>Cloudflare</span>
          </div>

          <button className="w-full h-12 bg-[#455A64] hover:bg-[#37474F] text-white rounded-md">
            Sign In
          </button>
        </form>

        {/* Terms */}
        <p className="text-[#9AA5B1] text-center text-sm mt-5">
          By continuing, you agree to Terms & Privacy Policy.
        </p>

        {/* Links */}
        <div className="flex justify-between mt-6 text-[#546E7A]">
        ...
        {/* Social Icons */}
        <div className="flex justify-center gap-6 mt-5 text-3xl">
          <a
